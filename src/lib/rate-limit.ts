...
export const RATE_LIMITS = {
  ...
  /** Push-notification dispatch. 10/min per user — each click fans out
   *  to every matching recipient server-side, so this caps how often a
   *  single admin can launch notification campaigns. */
